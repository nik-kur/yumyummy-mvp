...
> **Final cards live in `docs/aso/store-cards/`** (7 frames, 1290×2796),
> generated by `scripts/make_store_cards.py` from real device screenshots in
> `Screenshots July 18, 2026/`. Re-run the script to regenerate after copy or
> screenshot changes.
...
## App Preview video (15–30s, portrait **886×1920 only** for the 6.9" slot)

> ⚠️ Preview dimensions differ from screenshot dimensions. 6.9" screenshots
> are 1290×2796; the 6.9" preview video must be exactly 886×1920 (H.264,
> constant 30fps, stereo AAC audio track required even if silent). Uploading
> at screenshot size is the most common preview rejection.
