...
async def run_yumyummy_workflow(
    ...
    Args:
        ...
        image_url: Optional base64 data URI or URL of an image
        force_intent: Optional intent to skip router (e.g., "food_advice")
        nutrition_context: Optional JSON string with user's KBJU data for today
    ...
    try:
        ...
        try:
            ...
            result = await run_text(text=user_text, telegram_id=telegram_id, image_url=image_url,
